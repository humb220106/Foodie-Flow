        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantSlug = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ...
                    RestaurantBanner = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dishes_IsActive_Status_IsFeatured",
                table: "Dishes",
                columns: new[] { "IsActive", "Status", "IsFeatured" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Restaurants_RestaurantSlug",
                table: "Restaurants",
                column: "RestaurantSlug",
                unique: true,
                filter: "[RestaurantSlug] IS NOT NULL");
